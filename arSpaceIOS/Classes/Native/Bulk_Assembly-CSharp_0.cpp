...
extern String_t* _stringLiteral1908193706;
...
public:
	...
	int32_t ___ememiesKilled_2;

public:
	inline static int32_t get_offset_of_ememiesKilled_2() { return static_cast<int32_t>(offsetof(collisionScript_t2453821997_StaticFields, ___ememiesKilled_2)); }
	inline int32_t get_ememiesKilled_2() const { return ___ememiesKilled_2; }
	inline int32_t* get_address_of_ememiesKilled_2() { return &___ememiesKilled_2; }
	inline void set_ememiesKilled_2(int32_t value)
	{
		___ememiesKilled_2 = value;
	}
};
...
extern "C"  void collisionScript_OnTriggerEnter_m3054314804 (collisionScript_t2453821997 * __this, Collider_t1773347010 * ___col0, const RuntimeMethod* method)
{
	...
	}
	{
		...
		Object_t631007953 * L_5 = Resources_Load_m3480190876(NULL /*static, unused*/, _stringLiteral1908193706, L_4, /*hidden argument*/NULL);
		...
		int32_t L_15 = ((collisionScript_t2453821997_StaticFields*)il2cpp_codegen_static_fields_for(collisionScript_t2453821997_il2cpp_TypeInfo_var))->get_ememiesKilled_2();
		((collisionScript_t2453821997_StaticFields*)il2cpp_codegen_static_fields_for(collisionScript_t2453821997_il2cpp_TypeInfo_var))->set_ememiesKilled_2(((int32_t)il2cpp_codegen_add((int32_t)L_15, (int32_t)1)));
	}

IL_0077:
	{
		GameObjectU5BU5D_t3328599146* L_16 = GameObject_FindGameObjectsWithTag_m2585173894(NULL /*static, unused*/, _stringLiteral2261822918, /*hidden argument*/NULL);
		NullCheck(L_16);
...
{
	{
		__this->set_mNextSpawnTime_7((3.0f));
		return;
	}
}
// System.Void EnemiesController::spawnEnemies()
...
extern "C"  void firstSceneBulletCollisionScript_OnTriggerEnter_m4076313682 (firstSceneBulletCollisionScript_t2388523700 * __this, Collider_t1773347010 * ___col0, const RuntimeMethod* method)
{
	...
	}
	{
		...
		((collisionScript_t2453821997_StaticFields*)il2cpp_codegen_static_fields_for(collisionScript_t2453821997_il2cpp_TypeInfo_var))->set_ememiesKilled_2(0);
	}
...
extern "C"  void webCamScript_Update_m4223067181 (webCamScript_t4220051822 * __this, const RuntimeMethod* method)
{
	...
	memset(&V_4, 0, sizeof(V_4));
	{
		...
		NullCheck(L_12);
		Transform_set_localRotation_m19445462(L_12, L_13, /*hidden argument*/NULL);
		float L_14 = __this->get_totalTime_6();
		float L_15 = Time_get_deltaTime_m372706562(NULL /*static, unused*/, /*hidden argument*/NULL);
		__this->set_totalTime_6(((float)il2cpp_codegen_subtract((float)L_14, (float)L_15)));
		float L_16 = __this->get_totalTime_6();
	...
	{
		float L_17 = __this->get_totalTime_6();
		webCamScript_UpdateLevelTimer_m2472818325(__this, L_17, /*hidden argument*/NULL);
	}

IL_008c:
	{
		float L_18 = __this->get_totalTime_6();
...
IL_00a6:
	{
		Text_t1901882714 * L_19 = __this->get_mKilledLabel_5();
		int32_t L_20 = ((collisionScript_t2453821997_StaticFields*)il2cpp_codegen_static_fields_for(collisionScript_t2453821997_il2cpp_TypeInfo_var))->get_ememiesKilled_2();
		int32_t L_21 = L_20;
		RuntimeObject * L_22 = Box(Int32_t2950945753_il2cpp_TypeInfo_var, &L_21);
		IL2CPP_RUNTIME_CLASS_INIT(String_t_il2cpp_TypeInfo_var);
		String_t* L_23 = String_Concat_m904156431(NULL /*static, unused*/, _stringLiteral1848871212, L_22, /*hidden argument*/NULL);
		NullCheck(L_19);
...
IL_0036:
	{
		Text_t1901882714 * L_7 = __this->get_timer_4();
